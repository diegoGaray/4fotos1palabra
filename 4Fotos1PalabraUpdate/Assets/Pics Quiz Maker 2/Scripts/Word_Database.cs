...
public class Word_Database : MonoBehaviour 
{
	...
	public string[,] uiTextsLang = new string[14, 26]
	{
		...
		// FILL THE SPACES OF THE ARRAY (THE QUOTATION MARKS) WITH THE CORRESPONDING TRANSLATION
									...
									/* The \n is for do a newline */
		/* LANGUAGE BY DEFAULT: */ {"NIVEL", "COMPLETADO", "JUGAR", "Resolver \n por mi", "Mostrar una letra\nde la respuesta", "monedas", "OK", "NO", "", "Necesitas monedas\nMira el Vídeo", "NIVELES", "Total Resueltos", "Porcentaje total", "", "Palabras resueltas", "Porcentaje resuelto", "MENU", "Palabras resueltas:", "Necesitas ", " palabras para desbloquear.", "Continuar", " ", " monedas", "¡Valóranos!", "Más tarde", "¡Pedir ayuda!"},
		/* LANGUAGE # 1:  */ 	   {"NIVEL", "COMPLETADO", "JUGAR", "Resolver \n por mi", "Mostrar una letra\nde la respuesta", "monedas", "OK", "NO", "", "Necesitas monedas\nMira el Vídeo", "NIVELES", "Total Resueltos", "Porcentaje total", "", "Palabras resueltas", "Porcentaje resuelto", "MENU", "Palabras resueltas:", "Necesitas ", " palabras para desbloquear.", "Continuar", " ", " monedas", "¡Valóranos!", "Más tarde", "¡Pedir ayuda!"},
		/* LANGUAGE # 2:  */       {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
		/* LANGUAGE # 3:  */       {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
		/* LANGUAGE # 4:  */       {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
		/* LANGUAGE # 5:  */       {"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""},
    ...
    void Awake () 
	{
        ...
        {
            ObscuredPrefs.SetInt("levelWord", 1);
        }

		if (!ObscuredPrefs.HasKey("coinsPlayer")) 
		{

			ObscuredPrefs.SetInt ("coinsPlayer", startWithCoins);
